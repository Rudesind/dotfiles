...
if empty(glob('$HOME/vimfiles/autoload/plug.vim'))
  silent !curl -fLo $vim/vimfiles/autoload/plug.vim --create-dirs
...
" 
set backup 
set backupdir^=$HOME/vimfiles/tmpBackup//

set swapfile
set directory^=$HOME/vimfiles/tmpSwap//

set undofile
set undodir^=$HOME/vimfiles/tmpUndo//
